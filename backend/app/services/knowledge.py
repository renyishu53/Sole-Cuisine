...
虾仁滑蛋盖饭：虾仁 150 克、鸡蛋 3 个，少油滑炒后搭配米饭，全程约 18 分钟。
不使用辣椒，适合时间紧张的工作日晚餐。

番茄鸡蛋面：番茄与鸡蛋提供酸甜口味，面条煮制约 20 分钟。儿童份减少盐和刺激性调味。

晚餐优先蒸、煮、烩，工作日控制在 30 分钟内，并通过复用菌菇、青菜等食材减少浪费。""",
    ),
    (
        "控糖饮食原则.md",
        "营养",
...
烹饪方式优先清蒸、炖煮和少油快炒。成员有少糖约束时，菜单与采购清单都应避免高糖加工食品。""",
    ),
    (
        "任务公平分配.md",
        "家务",
...
家务分配同时考虑成员空闲时间、任务时长和连续负担。儿童可以承担垃圾分类、整理玩具等低风险任务。
工作日晚间任务宜控制在 15 至 30 分钟；周末安排集中采购和深度清洁，并保留共同休息时间。""",
    ),
)
